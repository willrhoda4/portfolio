...
const codecademyIcon = document.getElementById("codecademy-icon");
const crecommIcon = document.getElementById("crecomm-icon");
const electricalIcon = document.getElementById("electrical-icon");

const codecademyInfo = document.getElementById("codecademy-info");
const crecommInfo = document.getElementById("crecomm-info");
const electricalInfo = document.getElementById("electrical-info");

const codecademyDescription = document.getElementById("codecademy-description");
const crecommDescription = document.getElementById("crecomm-description");
const electricalDescription = document.getElementById("electrical-description");




    codecademyIcon.addEventListener("mouseover", function() {
        codecademyInfo.style.color = "#00ABAA";
        codecademyIcon.style.transform = "translate(0, -2vh)";
        codecademyDescription.style.display = "block";
    });
    codecademyIcon.addEventListener("mouseout", function() {
        codecademyInfo.style.color = "white";
        codecademyIcon.style.transform = "translate(0, 1vh)";
        codecademyDescription.style.display = "none";
    });
    codecademyInfo.addEventListener("mouseover", function() {
        codecademyInfo.style.color = "#00ABAA";
        codecademyIcon.style.transform = "translate(0, -2vh)";
        codecademyDescription.style.display = "block";
    });
    codecademyInfo.addEventListener("mouseout", function() {
        codecademyInfo.style.color = "white";
        codecademyIcon.style.transform = "translate(0, 1vh)";
        codecademyDescription.style.display = "none";
    });
    ...
    crecommIcon.addEventListener("mouseover", function() {
        crecommInfo.style.color = "#00ABAA";
        crecommIcon.style.transform = "translate(0, -2vh)";
        crecommDescription.style.display = "block";
    });
    crecommIcon.addEventListener("mouseout", function() {
        crecommInfo.style.color = "white";
        crecommIcon.style.transform = "translate(0, 1vh)";
        crecommDescription.style.display = "none";
    });
    crecommInfo.addEventListener("mouseover", function() {
        crecommInfo.style.color = "#00ABAA";
        crecommIcon.style.transform = "translate(0, -2vh)";
        crecommDescription.style.display = "block";
    });
    crecommInfo.addEventListener("mouseout", function() {
        crecommInfo.style.color = "white";
        crecommIcon.style.transform = "translate(0, 1vh)";
        crecommDescription.style.display = "none";
    });
    ...
    electricalIcon.addEventListener("mouseover", function() {
        electricalInfo.style.color = "#00ABAA";
        electricalIcon.style.transform = "translate(0, -2vh)";
        electricalDescription.style.display = "block";
    });
    
    electricalIcon.addEventListener("mouseout", function() {
        electricalInfo.style.color = "white";
        electricalIcon.style.transform = "translate(0, 1vh)";
        electricalDescription.style.display = "none";
    });
    
    electricalInfo.addEventListener("mouseover", function() {
        electricalInfo.style.color = "#00ABAA";
        electricalIcon.style.transform = "translate(0, -2vh)";
        electricalDescription.style.display = "block";
    });
    
    electricalInfo.addEventListener("mouseout", function() {
        electricalInfo.style.color = "white";
        electricalIcon.style.transform = "translate(0, 1vh)";
        electricalDescription.style.display = "none";
    });
...
const wuButton = document.getElementById("wu-button");
const wuNameDispenser = document.getElementById("wu-name-dispenser");


wuButton.addEventListener("click", function () {
    ...
    wuNameDispenser.innerHTML = myWuNameIs(userFirstName, userLastName, userBirthMonth, userBirthDay);
